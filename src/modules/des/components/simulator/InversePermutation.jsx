        ...
        <div className="space-y-4">
          ...
          <div className="bg-brutal-white p-4 border-3 border-black shadow-brutal-sm flex flex-col items-center justify-center gap-4">
            <div className="w-full flex items-center justify-around gap-2 text-center text-xs font-grotesk font-black uppercase">
              <span className="p-2 border-2 border-black bg-brutal-orange/15 w-[45%] text-white">Blok R16 (32-bit)</span>
              <span className="font-black text-lg text-white">+</span>
              <span className="p-2 border-2 border-black bg-brutal-coral/15 w-[45%] text-white">Blok L16 (32-bit)</span>
            </div>
            
            <div className="font-mono text-center text-xs text-white/60 uppercase">
              ...
              <div className="flex flex-wrap gap-1 md:gap-2 justify-center">
                ...
                <div className="flex gap-1 p-1 bg-brutal-orange/10 border-2 border-dashed border-brutal-orange">
                  {result.preOutput.slice(0, 32).match(/.{1,4}/g)?.map((chunk, idx) => (
                    <span key={idx} className="font-mono text-xs font-bold tracking-widest bg-white border border-black px-1.5 py-0.5 text-black">{chunk}</span>
                  ))}
                </div>
                {/* L16 block */}
          ...
          <div className="pt-4">
            <div className="text-xs font-grotesk font-black uppercase text-white mb-4">
